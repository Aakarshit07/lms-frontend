                   ...
                   {/* Right UI */}
                    <div className="flex flex-col items-center gap-10 p-5 shadow-lg rounded-md">
                        ...
                        <div className="grid grid-cols-2 gap-5">
                            ...
                            <div className="flex items-center justify-between p-5 gap-5 rounded-md shadow-md">
                                <div className="flex flex-col items-center">
                                    <p className="font-semibold ">Total Revenu</p>
                            ...
                            {myCourses?.map((course, idx) =>{
                                return (
                                    <tr key={course._id}>
                                        ...
                                        <td className="max-2-28 overflow-hidden text-ellipsis whitespace-nowrap">
                                            <textarea
                                        ...
                                        <td className="flex items-center gap-4">
                                            <button 
                                                className="bg-green-500 hover:bg-green-500 transition-all ease-in-out duration-300 text-xl py-2 px-4 rounded-md font-bold"
                                            ...
                                            <button 
                                                className="bg-red-500 hover:bg-red-500 transition-all ease-in-out duration-300 text-xl py-2 px-4 rounded-md font-bold"
